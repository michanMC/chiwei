...
{
   // UIView *sourceView = _sourceImagesContainerView.subviews[_currentImageIndex];
    UIView *parentView = [self getParsentView:nil];
    CGRect rect = CGRectMake(0, 0, Main_Screen_Width, 200);//[sourceView.superview convertRect:sourceView.frame toView:parentView];
...
- (void)hidePhotoBrowser:(UITapGestureRecognizer *)recognizer
{
    ...
    HZPhotoBrowserView *view = (HZPhotoBrowserView *)recognizer.view;
        currentImageView = view.imageview;
    }
    ...
    CGRect targetTemp = CGRectMake(0, 0, Main_Screen_Width, 300);//[sourceView.superview convertRect:sourceView.frame toView:parentView];
